...
public interface SelectMapper {
	...
	@Select("SELECT *, " + "ST_Y(coord) AS latitude, " + "ST_X(coord) AS longitude, "
	...
	@Select("SELECT *, " + "ST_Y(coord) AS latitude, " + "ST_X(coord) AS longitude, "
			...
			+ "IF(${parkingFilter}, parking='Y', (parking='N' || parking='Y')) " + "ORDER BY distance ")

	public List<CafeDTOCoordTemp> getCafesListBoundary(@Param("userLong") double userLong,
			@Param("userLat") double userLat, @Param("boundary") int boundary, @Param("openFilter") int openFilterNum,
			@Param("petFilter") int petFilterNum, @Param("parkingFilter") int parkingFilterNum);
